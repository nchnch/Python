(function($) {
    $.fn.lazyload = function(options) {
        ...
        this.each(function() {
            var self = this;
            if (undefined == $(self).attr("src")) {
                $(self).attr("src", settings.placeholder);
            }
            self.loaded = !(undefined == $(self).attr("src") || settings.placeholder == $(self).attr("src") || ($.abovethetop(self, settings) || $.leftofbegin(self, settings) || $.belowthefold(self, settings) || $.rightoffold(self, settings)));
            $(self).one("appear", function() {
                if (!this.loaded) {
                    $("<img />").bind("load",
                        function() {
                            $(self).attr("src", $(self).attr("original"))[settings.effect](settings.effectspeed);
                            self.loaded = true;
                            loadCount++;
